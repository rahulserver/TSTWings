 ...
 */
public class GetTwitterDispName {
    ...
    public static String runThisClass(String username,String password) throws Exception{
        String url = "https://mobile.twitter.com/session/new";
        String url2 = "https://mobile.twitter.com/session";
        String url3 = "https://mobile.twitter.com/account";
        ...
        try {
            dispname = Jsoup.parse(formCode).getElementsByAttributeValue("class", "screen-name").get(0).text();
        } catch (Exception e) {
