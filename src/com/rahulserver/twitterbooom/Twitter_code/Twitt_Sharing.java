...
import com.rahulserver.twitterbooom.Twitter_code.Twitter_Handler.TwDialogListener;
...
public class Twitt_Sharing {
    ...
    public void authenticateAndSaveAccessToken() {
        mTwitter.setListener(mTwLoginDialogListener);
        mTwitter.authorize();
    }
    ...
    public void Share_Pic_Text_Titter(File image_path, String message,
        ...
        try {
            StatusUpdate st = null;
            if (message != null && (message.length() != 0)) {
                st = new StatusUpdate(message);
